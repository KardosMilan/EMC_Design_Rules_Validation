SamacSys ECAD Model
12194641/1264584/2.50/8/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "NCV898031D1R2G" (originalName "NCV898031D1R2G")
	...
	(compDef "NCV898031D1R2G" (originalName "NCV898031D1R2G") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "EN") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "ISNS") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "GND") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "GDRV") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "VFB") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "VC") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VIN") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "VDRV") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "NCV898031D1R2G"))
		...
		(attr "Manufacturer_Part_Number" "NCV898031D1R2G")
		(attr "Description" "Switching Voltage Regulators 2 MHZ SMPS")
		(attr "Datasheet Link" "https://www.onsemi.com/pub/Collateral/NCV898031-D.PDF?hkey=EF798316E3902B6ED9A73243A3159BB0")
		(attr "Height" "1.75 mm")
	)
