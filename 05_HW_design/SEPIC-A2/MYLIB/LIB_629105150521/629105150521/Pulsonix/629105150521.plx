...
(library Library_1
	...
	(patternDef "629105150521" (originalName "629105150521")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 0.000, 0.415) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -4 -3.3) (pt 4 -3.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 4 -3.3) (pt 4 3.3) (width 0.025))
		)
	...
	(compDef "629105150521" (originalName "629105150521") (compHeader (numPins 9) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://www.we-online.com/components/products/datasheet/629105150521.pdf")
		(attr "<Component Height>" "2.86")
		(attr "<STEP Filename>" "629105150521.stp")
		(attr "<STEP Offsets>" "X=0;Y=2.07;Z=1")
